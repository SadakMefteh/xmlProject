    ...
    <div class="right">
      ...
      <form action="ajoutcategories.php" method="post">
        <div class="form-group">
          <label class="form-label" for="nomcat">le nom du catégorie</label>
          <input type="text" class="form-control" name="nomcat" id="nomcat" placeholder="Entrer le nom du categorie" required>
        </div>
        <!-- Champ de type file -->
    <div class="form-group">
        <label for="photo">Ajouter une photo de cette categorie:</label>
